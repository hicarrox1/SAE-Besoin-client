...
def afficher_allumettes(allumettes):
    ...
    toolbox.afffichage_box(texte = f"Nombre d'allumettes restantes : {allumettes}\n" + "Allumettes : " + "|" * allumettes, padding= 1, center_texte=True)
...
def jeu_allumettes_2_joueurs():
    ...
    toolbox.afffichage_box(texte = "Qui commence ? \n'1': Joueur 1\n'2': Joueur 2\n'A': aléatoire", center_texte=True)
    ...
    while allumettes > 0:
        ...
        choix_allumettes = int(input(f"Joueur {joueur_actuel}, combien d'allumettes souhaitez-vous retirer ? (1, 2 ou 3) : "))
